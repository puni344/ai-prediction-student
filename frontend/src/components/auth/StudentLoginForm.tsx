    ...
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-xs text-slate-400">
          Sign in to access your academic trajectory and performance console
        </p>
      </div>
      ...
      <Card className="border border-white/10 shadow-2xl p-6 sm:p-8 backdrop-blur-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full rounded-xl border ${
                  fieldErrors.email ? "border-rose-500/80 bg-rose-500/5 focus:border-rose-500" : "border-white/10 bg-white/4 focus:border-indigo-500"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className={`w-full rounded-xl border ${
                  fieldErrors.password ? "border-rose-500/80 bg-rose-500/5 focus:border-rose-500" : "border-white/10 bg-white/4 focus:border-indigo-500"
          ...
          >
            {isLoading ? "Signing in..." : "Sign In to Student Lab"}
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-slate-400">
            ...
            <Link to="/student/register" className="font-semibold text-indigo-400 hover:text-indigo-300 transition-colors">
